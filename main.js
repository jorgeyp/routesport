...
var TileWMS = function(coord,zoom) {
  var x = document.getElementById("wms-texto");
  ...
  var wmsMapUrl = wmsUrl + "&REQUEST=GetMap&CRS=EPSG:4326&WIDTH=256&HEIGHT=256&FORMAT=image/png&TRANSPARENT=true&LAYERS=" + wmsLayers + "&STYLE=" + wmsStyle + "&BBOX=" + bbox;
  
  console.log(wmsMapUrl)
